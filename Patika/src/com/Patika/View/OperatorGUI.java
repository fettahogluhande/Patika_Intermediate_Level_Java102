...
public class OperatorGUI extends JFrame {
    ...
    private JComboBox cmb_user_box;
    private JButton byn_user_add;
    ...
    public OperatorGUI(Operator operator) {
       ...
       /* cmb_course_patika.addItem(new Item(1,"1.Eleman"));
        ...
        byn_user_add.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (Helper.isFieldEmpty(fld_user_name) || Helper.isFieldEmpty(fld_user_uname) || Helper.isFieldEmpty(fld_user_pass)) {
                    ...
                    String type = cmb_user_box.getSelectedItem().toString();
